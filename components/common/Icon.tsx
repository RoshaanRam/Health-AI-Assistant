...
type IconName = 'clipboard' | 'calendar' | 'microphone' | 'sparkles' | 'loader' | 'location' | 'chevron-left' | 'chevron-right' | 'close';
...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
  ...
  const icons: Record<IconName, React.ReactElement> = {
    ...
    microphone: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12 5.25v-1.5m-6 7.5v-1.5m-6-6h12m-6 7.5a6 6 0 00-6-6v-1.5a6 6 0 0112 0v1.5a6 6 0 01-6 6z" />
      </svg>
    ),
    sparkles: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
